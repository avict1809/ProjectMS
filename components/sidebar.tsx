...
const sidebarItems = [
  ...
  {
    section: "Settings",
    items: [{ label: "Project Settings", icon: Settings, link: "/dashboard/settings" }],
  },
];
  ...
  return (
    <>
        ...
        <div className="px-2">
          <Link
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-lg ${
              pathname === "/dashboard" ? "bg-blue-500 text-white" : "hover:text-blue-500"
            }`}
          >
            <Home size={20} />
            <span>Dashboard</span>
      ...
      <nav className="fixed bottom-0 left-0 w-full bg-black text-gray-300 border-t border-gray-700 flex md:hidden justify-around py-3">
        <Link href="/dashboard" className={`flex flex-col items-center ${pathname === "/dashboard" ? "text-blue-500" : "hover:text-blue-500"}`}>
          <Home size={20} />
        </Link>
        <Link href="/dashboard/projects" className={`flex flex-col items-center ${pathname === "/dashboard/projects" ? "text-blue-500" : "hover:text-blue-500"}`}>
          <Folder size={20} />
        </Link>
        <Link href="/dashboard/tasks" className={`flex flex-col items-center ${pathname === "/dashboard/tasks" ? "text-blue-500" : "hover:text-blue-500"}`}>
          <ListChecks size={20} />
        </Link>
        <Link href="/dashboard/reports" className={`flex flex-col items-center ${pathname === "/dashboard/reports" ? "text-blue-500" : "hover:text-blue-500"}`}>
          <BarChart size={20} />
        </Link>
        <Link href="/dashboard/settings" className={`flex flex-col items-center ${pathname === "/dashboard/settings" ? "text-blue-500" : "hover:text-blue-500"}`}>
          <Settings size={20} />
        </Link>
      </nav>
    </>
